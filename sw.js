...
const CARD_ASSETS = [
  ...
  './data/cards/a-4.webp',
  './data/cards/a-5.webp',
  './data/cards/amaterasu.webp',
  './data/cards/anansi.webp',
  './data/cards/anu.webp',
  './data/cards/anubis.webp',
  './data/cards/artemis.webp',
  './data/cards/athena.webp',
  './data/cards/b-1.webp',
  './data/cards/b-2.webp',
  './data/cards/b-3.webp',
  './data/cards/baba-yaga.webp',
  './data/cards/bastet.webp',
  './data/cards/brahma.webp',
  './data/cards/c-1.webp',
  './data/cards/c-2.webp',
  './data/cards/c-3.webp',
  ...
  './data/cards/cerbere.webp',
  './data/cards/cernunnos.webp',
  './data/cards/chaac.webp',
  './data/cards/corbeau-createur.webp',
  './data/cards/d-1.webp',
  './data/cards/d-2.webp',
  './data/cards/d-3.webp',
  './data/cards/d-4.webp',
  './data/cards/dagda.webp',
  ...
  './data/cards/durga.webp',
  './data/cards/e-1.webp',
  './data/cards/e-2.webp',
  './data/cards/e-3.webp',
  './data/cards/enki.webp',
  './data/cards/epona.webp',
  './data/cards/eshu.webp',
  './data/cards/f-1.webp',
  './data/cards/f-2.webp',
  './data/cards/f-3.webp',
  './data/cards/f-4.webp',
  './data/cards/fenghuang.webp',
  ...
  './data/cards/fenrir.webp',
  './data/cards/freyja.webp',
  './data/cards/fujin.webp',
  './data/cards/g-1.webp',
  './data/cards/g-2.webp',
  './data/cards/g-3.webp',
  './data/cards/ganesh.webp',
  './data/cards/gilgamesh.webp',
  './data/cards/gitche-manitou.webp',
  './data/cards/guanyin.webp',
  './data/cards/hanuman.webp',
  './data/cards/heimdall.webp',
  './data/cards/hera.webp',
  './data/cards/hermes.webp',
  ...
  './data/cards/hine-nui-te-po.webp',
  './data/cards/horus.webp',
  './data/cards/inari.webp',
  './data/cards/ishtar.webp',
  './data/cards/isis.webp',
  './data/cards/ixchel.webp',
  './data/cards/jormungandr.webp',
  './data/cards/jupiter.webp',
  './data/cards/kappa.webp',
  './data/cards/kokopelli.webp',
  './data/cards/kukulkan.webp',
  './data/cards/lamassu.webp',
  './data/cards/loki.webp',
  './data/cards/long.webp',
  ...
  './data/cards/lugh.webp',
  './data/cards/mami-wata.webp',
  './data/cards/mars.webp',
  './data/cards/maui.webp',
  './data/cards/morrigan.webp',
  ...
  './data/cards/neptune.webp',
  './data/cards/nuwa.webp',
  './data/cards/nyame.webp',
  './data/cards/nyx.webp',
  './data/cards/odin.webp',
  './data/cards/oya.webp',
  './data/cards/pele.webp',
  './data/cards/perun.webp',
  './data/cards/quetzalcoatl.webp',
  './data/cards/raijin.webp',
  './data/cards/raven.webp',
  './data/cards/roussalka.webp',
  './data/cards/saraswati.webp',
  './data/cards/sedna.webp',
  './data/cards/shiva.webp',
  './data/cards/sobek.webp',
  './data/cards/sphinx.webp',
  './data/cards/sun-wukong.webp',
  './data/cards/susanoo.webp',
  './data/cards/tane-mahuta.webp',
  './data/cards/tangaroa.webp',
  './data/cards/tengu.webp',
  './data/cards/thor.webp',
  './data/cards/thot.webp',
  './data/cards/tlaloc.webp',
  './data/cards/tsukuyomi.webp',
  './data/cards/veles.webp',
  './data/cards/yu-huang.webp',
  './data/cards/z-1.webp',
  './data/cards/z-2.webp',
  './data/cards/z-3.webp',
