...
- corpus de **981 exercices et 355 leçons** CP à CM2 sur maths, français, histoire, géographie, sciences et EMC (chiffres de [CONTENT_ARCHITECTURE.md](CONTENT_ARCHITECTURE.md), généré depuis `data/`)
