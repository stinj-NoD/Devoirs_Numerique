...
const UI = {
    ...
    renderMenu(id, data, callback) {
        ...
        (data || []).forEach(item => {
            ...
            const reviewBadgeHtml = (menuVariant === 'exercises' && needsReview)
    ...
    renderProgressScreen(stats, onSelectExercise) {
        ...
        stats.subjects.forEach((subject) => {
            ...
            header.innerHTML = `
                <span class="progress-subject-icon">${this.safeIcon(subject.icon, '📘')}</span>
                ...
                <span class="progress-subject-chevron">▾</span>`;
