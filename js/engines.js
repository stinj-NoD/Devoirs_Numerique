    ...
    run(type, params = {}, lib = {}) {
        ...
        try {
            ...
            switch (engineType) {
                ...
                case 'matching':
                    result = this.generators.matching(params);
                    break;

                case 'word-order':
                    result = this.generators.wordOrder(params);
                    break;
...
matching(...args) {
    return EnginesDocumentary.matching(...args);
},

wordOrder(...args) {
    return EnginesDocumentary.wordOrder(...args);
},
